...
import './App.css'
import save_ico from './icons/NRD-00001_02013_ICO_Save cccccc_001.svg' 
import delete_ico from './icons/NRD-00001_02013_ICO_Delete cccccc_001.svg'
import edit_ico from './icons/NRD-00001_02013_ICO_Edit cccccc_001.svg'
      ...
      <div className="container main-container ">
        ...
        <div className="row">
          ...
          <div className="col-6">
            <div class="form-group">
              <label for="formGroupExampleInput">Entity Name</label>
              <input type="text" class="form-control" id="formGroupExampleInput" placeholder=" " />
            </div>
          </div>
          <div className="col-4">
            <div class="form-group">
              <label for="formGroupExampleInput">C/O Name</label>
              <input type="text" class="form-control" id="formGroupExampleInput" placeholder=" " />
            </div>
          </div>
        </div>
          ...
          <div className="col-6">
            <div class="form-group align-residence">
              <div class="form-check">
                ...
                <label class="form-check-labels" for="gridCheck">
        ...
        <div>
          ...
          <thead>
            ...
            <div class="form-check  form-check-align-small-thead">
            ...
            <tr>
              ...
              <th scope="row">
                ...
                <div class="form-check">
                    ...
                    <input class="form-check-input form-check-align-small" type="checkbox" id="gridCheck" />                      
